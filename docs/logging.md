...
.. important::
   ...
   But `new_extra_logger <#click_extra.logging.new_extra_logger>`_ always creates new loggers by setting their ``propagate`` attribute to ``False``. This means that messages of new loggers won't be propagated to their parents.
