...
| `click-extra` ↴ \\ `cloup` →   | Spec           | `4.0` | `3.1` | `3.0.7` | `3.0.0` | `2.1` | `2.0` | `1.0` | `0.14` | `0.13` | `0.12` |
| :----------------------------- | :------------- | :---: | :---: | :-----: | :-----: | :---: | :---: | :---: | :----: | :----: | :----: |
| `6.0.x` (2025-09-25) → `9.x`   | `>=3.0.7`      |  ✅   |  ✅   |   ✅    |   ❌    |  ❌   |  ❌   |  ❌   |   ❌   |   ❌   |   ❌   |
| `4.9.x` (2024-07-25) → `5.1.x` | `~=3.0.5`      |  ❌   |  ❌   |   ✅    |   ❌    |  ❌   |  ❌   |  ❌   |   ❌   |   ❌   |   ❌   |
| `4.6.4` (2023-08-23) → `4.8.x` | `^3.0.1`       |  ❌   |  ✅   |   ✅    |   ❌    |  ❌   |  ❌   |  ❌   |   ❌   |   ❌   |   ❌   |
| `4.6.2` (2023-07-15) → `4.6.3` | `^3.0.0`       |  ❌   |  ✅   |   ✅    |   ✅    |  ❌   |  ❌   |  ❌   |   ❌   |   ❌   |   ❌   |
| `4.2.x` (2023-05-23) → `4.6.1` | `^2.1.0`       |  ❌   |  ❌   |   ❌    |   ❌    |  ✅   |  ❌   |  ❌   |   ❌   |   ❌   |   ❌   |
| `3.4.x` (2022-12-01) → `4.1.x` | `^2.0.0.post1` |  ❌   |  ❌   |   ❌    |   ❌    |  ✅   |  ✅   |  ❌   |   ❌   |   ❌   |   ❌   |
| `3.3.2` (2022-11-14) → `3.3.4` | `>=1,<3`       |  ❌   |  ❌   |   ❌    |   ❌    |  ✅   |  ✅   |  ✅   |   ❌   |   ❌   |   ❌   |
| `3.0.x` (2022-08-07) → `3.3.1` | `^1.0.0`       |  ❌   |  ❌   |   ❌    |   ❌    |  ❌   |  ❌   |  ✅   |   ❌   |   ❌   |   ❌   |
| `2.1.1` (2022-05-22) → `2.1.3` | `^0.14.0`      |  ❌   |  ❌   |   ❌    |   ❌    |  ❌   |  ❌   |  ❌   |   ✅   |   ❌   |   ❌   |
