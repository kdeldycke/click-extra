...
| `click-extra` ↴ \\ `cloup` → | `4.0.x` | `3.0.7` | `3.0.0` | `2.1.x` | `2.0.x` | `1.0.x` | `0.14.x` | `0.13.x` | `0.12.x` |
| :--------------------------- | :-----: | :-----: | :-----: | :-----: | :-----: | :-----: | :------: | :------: | :------: |
| `6.0.x` → `9.x`              |   ✅    |   ✅    |   ❌    |   ❌    |   ❌    |   ❌    |    ❌    |    ❌    |    ❌    |
| `4.6.4` → `5.1.x`            |   ❌    |   ✅    |   ❌    |   ❌    |   ❌    |   ❌    |    ❌    |    ❌    |    ❌    |
| `4.6.2` → `4.6.3`            |   ❌    |   ✅    |   ✅    |   ❌    |   ❌    |   ❌    |    ❌    |    ❌    |    ❌    |
