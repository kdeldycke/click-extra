...
.. graphviz::
   ...
   digraph NON_OVERLAPPING_GROUPS {
       graph [fontname="Helvetica,Arial,sans-serif" fontsize=36 label=<<BR/><BR/><FONT FACE="Courier New"><B>click_extra.platforms.NON_OVERLAPPING_GROUPS</B></FONT><BR/><BR/><I>Non-overlapping groups.</I><BR/><BR/><FONT COLOR="gray">Click Extra v3.8.0</FONT><BR/>> rankdir=LR]
...
.. graphviz::
   ...
   digraph EXTRA_GROUPS {
       graph [fontname="Helvetica,Arial,sans-serif" fontsize=36 label=<<BR/><BR/><FONT FACE="Courier New"><B>click_extra.platforms.EXTRA_GROUPS</B></FONT><BR/><BR/><I>Overlapping groups, defined for convenience.</I><BR/><BR/><FONT COLOR="gray">Click Extra v3.8.0</FONT><BR/>> rankdir=LR]
       node [color=lightblue2 fontname="Helvetica,Arial,sans-serif" style=filled]
       edge [dir=none fontname="Helvetica,Arial,sans-serif"]
       subgraph unix {
           cluster=true;
