...
- Test coverage is measured with `pytest-cov` and gated by the `[tool.coverage] report.fail_under` ratchet. There is no external coverage service: repomatic dropped its Codecov integration in `7.8.0`.
