...
default_options_uncolored_help = (
    ...
    r"  --dump-config FORMAT         Dump the configuration in the selected format to\n"
    r"                               <stdout>, then exit\.\n"
...
default_options_colored_help = (
    ...
    r"  \x1b\[36m\x1b\[1m--dump-config\x1b\[0m \x1b\[36m\x1b\[2m\x1b\[3mFORMAT\x1b\[0m         Dump the configuration in the selected format to\n"
    r"                               <stdout>, then exit\.\n"
