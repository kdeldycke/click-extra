...
extensions/highlight/)'s formatter classes so that `Token.Ansi.*` tokens produced by
...
When [mkdocs-click](https://pypi.org/project/mkdocs-click/) is installed, the plugin
