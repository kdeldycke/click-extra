...
- Allow `@extra_group`, `@extra_command`, `@color_option`, `@config_option`, `@table_format_option`, `@timer_option` and `@verbosity_option` decorators to be used without parenthesis.
