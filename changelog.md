...
## [7.7.0.dev0 (unreleased)](https://github.com/kdeldycke/click-extra/compare/v7.6.5...main)
...
- Add `json`, `toml` and `yaml` table formats for `--table-format`.
- Add `[toml]` extra dependency group for TOML writing support.
